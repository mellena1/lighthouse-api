...
func NewPostLighthouseStateParams() PostLighthouseStateParams {
	...
	return PostLighthouseStateParams{}
}

// PostLighthouseStateParams contains all the bound params for the post lighthouse state operation
...
func (o *PostLighthouseStateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body PostLighthouseStateBody

...
func (o *PostLighthouseStateURL) WithBasePath(bp string) *PostLighthouseStateURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostLighthouseStateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostLighthouseStateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostLighthouseStateURL")
	}

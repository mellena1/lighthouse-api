...
var lighthouseTypeStatePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		lighthouseTypeStatePropEnum = append(lighthouseTypeStatePropEnum, v)
	}
}
...
// prop value enum
func (m *Lighthouse) validateStateEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, lighthouseTypeStatePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Lighthouse) validateState(formats strfmt.Registry) error {
